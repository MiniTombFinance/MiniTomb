  ...
  function mintBronze(uint256 _mintAmount) public payable {
   ...
   if (msg.sender != owner()) {
        if(onlyWhitelisted == true) {
            ...
            IERC20(erc20Address).transferFrom(msg.sender, treasuryAddress, 250000000000000000000 * _mintAmount);
   }
   ...
   if (msg.sender != owner()) {
        if(onlyWhitelisted == true) {
            ...
            IERC20(erc20Address).transferFrom(msg.sender, treasuryAddress, 1350000000000000000000 * _mintAmount);
   }
   ...
   if (msg.sender != owner()) {
        if(onlyWhitelisted == true) {
            ...
            IERC20(erc20Address).transferFrom(msg.sender, treasuryAddress, 2700000000000000000000 * _mintAmount);
   }
  ...
  function mintDiamond(uint256 _mintAmount) public payable {
   ...
   if (msg.sender != owner()) {
        if(onlyWhitelisted == true) {
            ...
            IERC20(erc20Address).transferFrom(msg.sender, treasuryAddress, 5400000000000000000000 * _mintAmount);
   }
